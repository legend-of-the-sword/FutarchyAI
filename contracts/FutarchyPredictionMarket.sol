...
contract FutarchyPredictionMarket {
    ...
    function getVoteCounts(uint256 _questionIndex) public view returns (uint256 yesVotes, uint256 noVotes) {
        Question storage question = questions[_questionIndex];
        yesVotes = question.votes[Decision.Yes];
        noVotes = question.votes[Decision.No];
    }
}